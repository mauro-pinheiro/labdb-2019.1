...
CREATE TABLE `cliente_enderecos` (
  ...
  KEY `FKbnbsija7m45gv41thqjbhu924` (`id_cliente`),
  CONSTRAINT `FKbnbsija7m45gv41thqjbhu924` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id`)
...
-- Dump completed on 2019-08-29  8:48:35
